        ...
        <div class="my-auto">
            ...
            <ul class="fa-ul mb-4 ml-0">
                <li id="mail-address">
                    ...
                    <i class="fas fa-envelope-open mr-2 contact-icons"></i>vothithuyngan2511@gmail.com</a>
                </li>
                <li>
                    <i class="fas fa-mobile-alt mr-2 contact-icons"></i>0397224784
                </li>
                <li>
                    <i class="fas fa-map-marker-alt mr-2 contact-icons"></i>Cái Răng - Cần Thơ
                </li>
            </ul>
